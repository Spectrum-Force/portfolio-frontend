...
const About = () => {
  return (
    <div className='bg-[#555555] justify-center items-center pt-10 px-10 space-y-10'>
      ...
      <div className='flex justify-between items-center space-x-6 '>
        <div className='w-[33%]'>
          ...
          <div className="flex items-center mt-2 relative w-full">
            ...
            <div className="h-1 bg-[#72D5F4] absolute" style={{ width: '80%' }}></div>
          </div>
        </div>
        <div className='w-[33%]'>
          ...
          <div className="flex items-center mt-2 relative w-full">
            <div className="h-1 bg-[#0101011A] w-full rounded-md"></div>
            <div className="h-1 bg-[#72D5F4] absolute" style={{ width: '70%' }}></div>
          </div>
        ...
        <div className='w-[33%]'>
          ...
          <div className="flex items-center mt-2 relative w-full">
            <div className="h-1 bg-[#0101011A] w-full rounded-md"></div>
            <div className="h-1 bg-[#72D5F4] absolute" style={{ width: '90%' }}></div>
          </div>
    ...
    <div className='flex justify-between items-center space-x-6'>
     ...
     <div className='w-[33%]'>
          ...
          <div className="flex items-center mt-2 relative">
            <div className="h-1 bg-[#0101011A] w-full rounded-md"></div>
            <div className="h-1 bg-[#72D5F4] absolute" style={{ width: '75%' }}></div>
          </div>
